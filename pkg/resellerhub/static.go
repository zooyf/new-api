  ...
  (function () {
    ...
    var messages = {
      zh: {
        ...
        nav_workspace: '工作区', dashboard: '总览', resellers: '代理商', members: '成员', customers: '客户', discounts: '折扣', keys: '客户 API Key', quota: '额度调整', ledger: '额度账本', usage: '用量', audit: '审计',
        ...
        reseller_management: '代理商管理', reseller_desc: '创建代理商、绑定额度承载账号并维护默认折扣。', new_reseller: '新建代理商', reseller_name: '代理商名称', reseller_code: '代理商编码', reseller_code_hint: '系统创建时自动生成，作为稳定唯一标识，创建后不可修改。', status: '状态', default_discount: '默认折扣', carrier_user: '额度承载账号 ID', carrier_user_hint: '普通用户账号，一个账号只能作为一个代理商的额度承载账号。', created_at: '创建时间', updated_at: '更新时间', actions: '操作',
        ...
        customer_management: '客户管理', customer_desc: '客户不创建独立登录账号，每个客户第一期只允许一个 Active Key。', new_customer: '新建客户', customer_name: '客户名称', external_ref: '外部客户编号（选填）', external_ref_help: '用于关联你在 CRM、ERP 或合同系统中的客户编号；同一代理商内不可重复，可留空。', customer_requires_reseller: '请先创建并选择代理商，然后才能新建客户。', customer_discount: '客户折扣', inherit_discount: '继承代理商默认折扣', effective_discount: '有效折扣',
        setup_guide: '首次配置流程', setup_guide_desc: '当前还没有代理商数据，请按顺序完成以下四步。', setup_step_reseller: '1. 创建代理商并选择额度承载账号', setup_step_member: '2. 将现有登录账号添加为代理商管理员或只读成员', setup_step_customer: '3. 在代理商下创建客户并设置折扣', setup_step_key: '4. 为客户创建受额度控制的 API Key', start_setup: '开始创建代理商',
        discount_management: '折扣管理', discount_desc: '客户覆盖折扣优先于代理商默认折扣，历史版本不会被覆盖。', select_customer: '选择客户', set_discount: '设置折扣', discount_bps: '折扣基点', discount_help: '10000 = 原价，8500 = 85 折。留空表示继承代理商默认折扣。', effective_at: '生效时间', source: '来源', reason: '原因', history: '历史版本',
      ...
      en: {
        ...
        nav_workspace: 'Workspace', dashboard: 'Overview', resellers: 'Resellers', members: 'Members', customers: 'Customers', discounts: 'Discounts', keys: 'Customer API keys', quota: 'Quota adjustments', ledger: 'Quota ledger', usage: 'Usage', audit: 'Audit',
